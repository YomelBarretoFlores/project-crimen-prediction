...
El proceso de sintonización y ajuste de hiperparámetros se llevó a cabo utilizando validación cruzada temporal (*TimeSeriesSplit*). 
...
```
*La documentación automática de la API y los servicios estará disponible en `http://localhost:8000/docs`.*
...
```
*El sistema se renderizará en el ambiente de escritorio bajo `http://localhost:8501`.*
...
* **Documentación Académica:** Referencias sobre el proceso científico e iteración matemática pueden encontrarse adjuntas en la memoria del proyecto (Documento PD-UNASAM).
